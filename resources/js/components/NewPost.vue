    ...
    <div class="bg-white rounded shadow w-2/3 p-4">
        <div class="flex justify-between items-center">
            ...
            <div class="flex-1 flex mx-4">
                <input type="text" v-model="postMessage" name="body" class="w-full pl-4 h-8 bg-gray-200 rounded-full" placeholder="Add a Post">
            ...
            <div id="dz-template" class="hidden">
                <div class="dz-preview dz-file-preview mt-4">
                    <div class="dz-details">
                            ...
                            <button data-dz-remove class="text-xs"><R>REMOVE</R></button>
                    </div>
                    <div class="dz-progress">
                        <span class="dz-upload" data-dz-upload>
